...
(function (factory) {
  ...
  Cropper.prototype = {
    ...
    initContainer: function () {
      ...
      let width = window.innerWidth > 420 ? (parseInt(window.innerWidth * 0.8) > 980 ? 980 : parseInt(window.innerWidth * 0.8)) : parseInt(window.innerWidth * 0.9);
      let height = window.innerWidth < 450 ? parseInt(window.innerHeight * 0.6) : parseInt(window.innerHeight * 0.7);
