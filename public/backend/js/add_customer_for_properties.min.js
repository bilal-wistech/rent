jQuery.validator.addMethod(
    ...
    $("#phone").intlTelInput({
        ...
        utilsScript:
            "../public/backend/js/intl-tel-input-13.0.0/build/js/utils.js",
    });
var hasPhoneError = !1,
    hasEmailError = !1;
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status === "success") {
                ...
                $("#city").append('<option value="' + newCity.id + '">' + newCity.name + '</option>');
                $("#city").val(newCity.id);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status === "success") {
                ...
                $("#area").append('<option value="' + newArea.id + '">' + newArea.name + '</option>');
                $("#area").val(newArea.id);
