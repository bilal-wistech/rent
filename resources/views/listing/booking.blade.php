                                ...
                                <div class="col-md-12 p-0 mt-4 border rounded pb-4 m-0">
                                    ...
                                    <div class="row m-0 pl-5 pr-5">
                                        <div class="col-md-12 p-0">
                                            <h3>{{ __('Choose how your guests book') }} <span class="text-danger">*</span>
                                            </h3>
                                            <p class="text-muted">
                                                {{ __('Get ready for guests by choosing your booking style.') }}</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4 pl-5 pr-5">
                                            ...
                                            <select name="booking_type" id="booking_type" class="form-control text-16 mt-2">
                                                <option value="request"
                                                    ...
                                                    {{ __('Review each request') }}</option>
                                                <option value="instant"
                                                    {{ $result->booking_type == 'instant' ? 'selected' : '' }}>
                                                    {{ __('Guests book instantly') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
