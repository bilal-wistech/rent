                ...
                <div class="main-panel min-height mt-4">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-9 mt-4 mt-sm-0 pl-4 pr-4">
                            <form id="lis_location" method="post" action="{{ url('listing/' . $result->id . '/' . $step) }}"
                                ...
                                <div class="col-md-12 border mt-4 pb-5 rounded-3 pl-4 pl-sm-0 pr-4 pr-sm-0 ">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 pl-5 pr-5">
                                            ...
                                            <select id="basics-select-bed_type" name="country"
                                                class="form-control text-16 mt-2" id='country'>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6 mt-4 pl-5 pr-5">
                                            ...
                                            <input type="text" name="area" id="area"
                                                value="{{ $result->property_address->area }}"
                                                class="form-control text-16 mt-2" placeholder="">
                                        </div>
                                        @if ($result->property_type == 1)
                                            <div class="col-md-6 mt-4 pl-5 pr-5">
                                                <label>{{ __('Building') }}</label>
                                                <input type="text" name="building" id="building"
                                                    value="{{ $result->property_address->building }}"
                                                    class="form-control text-16 mt-2" placeholder="building">
                                            </div>
                                        @endif
                                        @if ($result->property_type == 1)
                                            <div class="col-md-6 mt-4 pl-5 pr-5">
                                                ...
                                                <input type="text" name="flat_no" id="flat_no"
                                                    value="{{ $result->property_address->flat_no }}"
                                                    class="form-control text-16 mt-2" placeholder="Flat No">
                                            </div>
                                        @endif
                                        <div class="col-md-6 mt-4 pl-5 pr-5">
                                            <label>{{ __('City / Town / District') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="city" id="city"
                                                value="{{ $result->property_address->city }} "
                                                class="form-control text-16 mt-2">
                                            <span class="text-danger">{{ $errors->first('city') }}</span>
                                        </div>

                                        <div class="col-md-6 mt-4 pl-5 pr-5">
                                            <label>{{ __('State / Province / County / Region') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-4 pl-5 pr-5">
                                            ...
                                            <input type="text" name="postal_code" id="postal_code"
                                                value="{{ $result->property_address->postal_code }}"
                                                class="form-control text-16 mt-2">
                                ...
                                <div class="col-md-12 p-0 mt-4 mb-5">
                                    <div class="row justify-content-between">
                                        <div class="mt-4">
                                            <a href="{{ url('listing/' . $result->id . '/description') }}"
                                                class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3">
                                                {{ __('Back') }}
                                            </a>
                                        </div>
