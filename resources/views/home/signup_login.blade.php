...
@section('main')
    <div class="container mb-4 margin-top-85 min-height">
        <div class="d-flex justify-content-center">
            ...
            @endif --}}
                <form id="signup_form" name="signup_form" method="post" action="{{ url('create') }}"
                    ...
                    <div class="row text-16">
                        ...
                        <div class="form-group col-sm-12 p-0">
                            ...
                            <input type="text" class='form-control text-14 p-2' value="{{ old('email') }}"
                        ...
                        <div class="col-sm-12 p-0">
                            <label class="l-pad-none text-14">{{ __('Birthday') }} <span
                                    class="text-13 text-danger">*</span></label>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 pl-0 mt-2">
                                    <select name='birthday_month' class='form-control text-14 p-2' id='user_birthday_month'>
                                        ...
                                        @for ($m = 1; $m <= 12; ++$m)
                                            <option value="{{ $m }}"
                                                {{ old('birthday_month') == $m ? 'selected = "selected"' : '' }}>
                                ...
                                <div class="col-sm-4 mt-2">
                                    <select name='birthday_day' class='form-control text-14' id='user_birthday_day'>
                                        ...
                                        @for ($m = 1; $m <= 31; ++$m)
                                            <option value="{{ $m }}"
                                                {{ old('birthday_day') == $m ? 'selected = "selected"' : '' }}>
                                                {{ $m }}</option>
                                        @endfor
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-4 pr-0 mt-2">
                                    <select name='birthday_year' class='form-control text-14' id='user_birthday_year'>
                                        ...
                                        @for ($m = date('Y'); $m > date('Y') - 100; $m--)
                                            <option
                                                value="{{ $m }}"{{ old('birthday_year') == $m ? 'selected = "selected"' : '' }}>
                                                {{ $m }}</option>
                                        @endfor
                                    </select>
                                </div>
