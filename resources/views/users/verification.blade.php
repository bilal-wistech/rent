                                        ...
                                        <div class="pl-5 pr-5 p-3">
                                            <ul class="list-layout edit-verifications-list">
                                                ...
                                                @if (Auth::user()->users_verification->email == 'no' &&
                                                        Auth::user()->users_verification->facebook == 'no' &&
                                                        Auth::user()->users_verification->google == 'no')
                                                ...
                                                @else
                                                    @if (Auth::user()->users_verification->email == 'yes')
                                                        <li class="edit-verifications-list-item">
                                                            <h4 class="font-weight-700 text-16">{{ __('Email Address') }}
                                                            </h4>
                                                            <p class="pl-4">{{ __('You have confirmed your email:') }}
                                                                <b>{{ Auth::user()->email }}</b>.
                                                                {{ __('A confirmed email is important to allow us to securely communicate with you.') }}
                                                            </p>
                                                        </li>
                                                    @endif
                                                    <hr>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="disconnect-button-container">
                                                                        <a href="{{ url('facebookDisconnect') }}"
                                                                            class="btn btn-primary pl-4 pr-4 pt-3 pb-3 text-16 secondary-text-color-hover btn-block"
                                                                            data-method="post"
                                                                            rel="nofollow">{{ __('Disconnect') }}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    ...
                                                    @if (Auth::user()->users_verification->google == 'yes')
                                                        <li class="edit-verifications-list-item">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="disconnect-button-container">
                                                                        <a href="{{ url('googleDisconnect') }}"
                                                                            class="btn btn-warning pl-4 pr-4 pt-3 pb-3 text-16 secondary-text-color-hover  btn-block"
                                                                            data-method="post"
                                                                            rel="nofollow">{{ __('Disconnect') }}</a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    @if (Auth::user()->users_verification->email == 'no')
                                                        <li>
                                                            ...
                                                            <div class="row pl-4 pt-1">
                                                                <div class="col-md-9">
                                                                    <p>
                                                                        {{ __('Please verify your email address by clicking the link in the message we just sent to:') }}
                                                                        <b>{{ Auth::user()->email }}</b>.
                                                                    </p>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a
                                                                            href="{{ url('users/new_email_confirm?redirect=verification') }}">
                                                                            <button type="button"
                                                                                class="btn btn-outline-success pl-4 pr-4 pt-3 pb-3 text-14 text-weight-700 w-100">{{ __('Connect') }}</button>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="{{ url('facebookLoginVerification') }}">
                                                                            <button type="button"
                                                                                class="btn btn-outline-primary pl-4 pr-4 pt-3 pb-3 text-16 text-weight-700 w-100">{{ __('Connect') }}</button>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="connect-button">
                                                                        <a href="{{ url('googleLoginVerification') }}">
                                                                            <button type="button"
                                                                                class="btn btn-outline-warning pl-4 pr-4 pt-3 pb-3 text-16 text-weight-700 w-100">{{ __('Connect') }}</button>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
