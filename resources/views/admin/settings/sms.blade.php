                                    ...
                                    <div class="card-body">
                                        <form id="smsform" method="post" action="{{ url('admin/settings/sms') }}" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row mt-2">
                                                <label for="phone" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Twilio Phone Number<span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-2">
                                                <label for="sid" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Twilio SID<span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-2">
                                                <label for="token" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Twilio Token<span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-2">
                                                <label for="defaults" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Defaults</label>
                                                <div class="col-sm-6">
...
<script type="text/javascript">
    'use strict'
    let utilsScript = '{{ asset("js/intl-tel-input-13.0.0/build/js/utils.js") }}';
    var countryData = $("#phone").intlTelInput("getSelectedCountryData");
    let validNumberText = "{{ __('Please enter a valid International Phone Number.') }}";
</script>
<script src="{{ asset('backend/js/sms.min.js') }}" type="text/javascript"></script>
@endsection
@endsection
