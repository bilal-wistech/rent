                ...
                <div class="col-lg-9 col-12">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Email Setting Form</h3><span class="email_status">(<span
                                    class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
                        </div>

                        <form id="email_setting" method="post" action="{{ url('admin/settings/email') }}"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row mt-3 driver">
                                    ...
                                    <label for="inputEmail3"
                                        class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Email
                                        Protocol</label>

                                    <div class="col-sm-6">
                                        <select class="form-control f-14 validate_field protocol_type" id="driver"
                                            name="driver" aria-invalid="false">
                                            @foreach ($drivers as $key => $driver)
                                                <option value="{{ $key }}"
                                                    {{ $result['driver'] == $key ? 'selected' : '' }}>{{ $driver }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="form-group row mt-3 host">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="host" class="form-control f-14" id="host"
                                            placeholder="Host" value="{{ $result['host'] }}">
                                ...
                                <div class="form-group row mt-3 port">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="port" class="form-control f-14" id="port"
                                            placeholder="Port" value="{{ $result['port'] }}">
                                ...
                                <div class="form-group row mt-3 from_address">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="from_address" class="form-control f-14"
                                            id="from_address" placeholder="From Address"
                                ...
                                <div class="form-group row mt-3 from_name">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="from_name" class="form-control f-14" id="from_name"
                                            placeholder="From Name" value="{{ $result['from_name'] }}">
                                ...
                                <div class="form-group row mt-3 encryption">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="encryption" class="form-control f-14"
                                            id="encryption "placeholder="Encryption" value="{{ $result['encryption'] }}">
                                ...
                                <div class="form-group row mt-3 username">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="username" class="form-control f-14"
                                            id="username "placeholder="Username" value="{{ $result['username'] }}">
                                ...
                                <input type="hidden" class="email_status_check" name="email_status"
                                    value="{{ $result['email_status'] }}">
