                                    ...
                                    <form id="email_setting" method="post" action="{{ url('admin/settings/email') }}" class="form-horizontal">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row mt-3 host">
                                                <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Host <span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-3 port">
                                                <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Port <span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-3 from_address">
                                                <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">From Address <span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-3 from_name">
                                                <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">From Name <span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-3 encryption">
                                                <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Encryption <span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-3 username">
                                                <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Username <span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row mt-3 password">
                                                <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Password <span class="text-danger">*</span></label>
                                                <div class="col-sm-6">
