                ...
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form class="form-horizontal" action="{{ route('document.update', $document->id) }}"
                                id="add_customer" method="post" enctype="multipart/form-data" name="add_customer"
                                    ...
                                    <div class="form-group mt-3 row">
                                        ...
                                        <div class="col-sm-8 d-flex align-items-center">
                                            <div class="border border-light rounded p-1 me-3">
                                                <img src="{{ Storage::url($document->image) }}" class="document-image"
                                ...
                                <div class="form-group mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control" name="expire"
                                            value="{{ $document ? $document->expire : '' }}" id="expiry_date" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="type" class="form-control mt-3">
                                            ...
                                            <option value="passport" <?= $document->type == 'passport' ? 'selected' : '' ?>>
                                                Passport</option>
                                            <option value="emirates" <?= $document->type == 'emirates' ? 'selected' : '' ?>>
                                                Emirates</option>
                                            <option value="others" <?= $document->type == 'others' ? 'selected' : '' ?>>
                                                Others</option>
                                        </select>
