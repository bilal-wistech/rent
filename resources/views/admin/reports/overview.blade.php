				...
				<div class="box">
					...
					<div class="box-body">
						...
						<table class="scroll wide f-14">
							...
							<tr>
								<td width="25%">
									<img src='{{ asset("images/flags/flags-medium/" . strtolower($countryCode->code) . ".png") }}' width="35px" height="20px">
								</td>
								<td>
									{{ $countryCode->name }}
								</td>
...
<script src="{{ asset('backend/js/report.min.js') }}" type="text/javascript"></script>
@endsection