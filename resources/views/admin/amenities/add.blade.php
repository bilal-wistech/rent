@extends('admin.template')
	...
	<div class="content-wrapper">
        <section class="content-header">
			<h1>Amenitie Add Form<small>Add Amenities</small></h1>
				...
				<div class="col-lg-12 col-12">
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Amenitie Add Form</h3><span class="email_status" >(<span class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
						</div>

						<form id="add_amen" method="post" action="{{ url('admin/add-amenities') }}" class="form-horizontal" >
							{{ csrf_field() }}
							<div class="box-body">
                                <div class="form-group row mt-3 title">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="title" class="form-control f-14" id="title" placeholder="Name">
                                ...
                                <div class="form-group row mt-3 type_id">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control f-14 validate_field" id="status" name="type_id" aria-invalid="false">
                                            ...
                                            <option value="{{ $value }}">{{ $type_id }}</option>
							...
							<div class="box-footer">
								...
								<a class="btn btn-danger f-14" href="{{ url('admin/amenities') }}">Cancel</a>
