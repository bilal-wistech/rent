                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-xs-12 mb20">
                                        <label class="label-large fw-bold">Listing Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="name" class="form-control f-14"
                                            value=" {{ old('name', $description->properties->name) }}" placeholder=""
                                            maxlength="100">
                                ...
                                <div class="row">
                                    <div class="col-md-8  col-sm-12 col-xs-12 mb20">
                                        <label class="label-large fw-bold">Summary {{-- <span
                                                class="text-danger">*</span> --}}</label>
                                ...
                                <div class="row ">
                                    <div class="col-md-8  col-sm-12 col-xs-12 mb20">
                                        <p class="f-14">
                                            You can add more <a
                                                href="{{ url('admin/listing/' . $result->id . '/details') }}"
                                                class="secondary-text-color" id="js-write-more">details</a> Tell travelers
                                            about your space and hosting style.
                                        </p>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-6 text-left">
                                        <a data-prevent-default=""
                                            href="{{ url('admin/listing/' . $result->id . '/basics') }}"
