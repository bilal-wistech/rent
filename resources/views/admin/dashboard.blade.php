            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="{{ url('admin/customers') }}" class="small-box-footer f-14">More info <i
                ...
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="{{ url('admin/properties') }}" class="small-box-footer f-14">More info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="{{ url('admin/bookings') }}" class="small-box-footer f-14">More info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                        ...
                        <div class="box-body">
                            <div class="table-responsive f-14" id="property-content">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @if (!empty($vacantProperties) && $vacantProperties->count())
                                            @php
                                                $number =
                                                    1 +
                                                    ($vacantProperties->currentPage() - 1) *
                                                        $vacantProperties->perPage();
                                            @endphp
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="2" class="text-center">No vacant properties available.</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            ...
                            <small>(List of Booked Not Paid and Booked Partially Paid Bookings)</small>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive f-14" id="property-content">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @if (!empty($paymentReceipts) && $paymentReceipts->count())
                                            @php
                                                $number =
                                                    1 +
                                                    ($paymentReceipts->currentPage() - 1) * $paymentReceipts->perPage();
                                            @endphp
                                            @foreach ($paymentReceipts as $item)
                                                <tr>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="2" class="text-center">No Booked Not Paid or Booked
                                                    Partially Paid Bookings Found.</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
                                <div class="d-flex justify-content-end mt-4">
                                    {{ $paymentReceipts->links('vendor.pagination.bootstrap-4') }}
                                </div>
                            </div>
                        </div>
                    </div>
