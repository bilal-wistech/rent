...
<div class="content-wrapper">
	...
	@if(Session::has('testimonialSuccess'))
		<div class="alert alert-success">Testimonial has been added!</div>
	@endif

	@if(Session::has('testimonialError'))
		<div class="alert alert-danger">There was an error adding the testimonial!</div>
	@endif
									...
									<div class="card mb-4">
										<div class="card-header d-flex justify-content-between align-items-center">
											...
											@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'add_testimonial'))
												<a class="btn btn-sm btn-success" href="{{ url('admin/add-testimonials') }}">Add
													Testimonial</a>
											@endif
										</div>
