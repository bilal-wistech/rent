...
@section('main')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Renewal Bookings<small>Control panel</small></h1>
...
@section('validate_script')
    ...
    <script>
        $(document).on('click', '.cancel_renewal_booking', function() {
            const bookingId = $(this).data('cancel-renewal-booking');

            Swal.fire({
                icon: 'info',
                title: 'Info!',
                text: 'Are you sure you want to cancel the renewal booking?',
                ...
                if (result.isConfirmed) {
                    // AJAX call
                    $.ajax({
                        url: '{{ route('renewal-bookings.cancel-renewal-booking') }}', // Laravel route
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Cancelled!',
                                text: 'The renewal booking has been successfully cancelled.',
                            }).then(() => {
                    ...
                    Swal.fire('The renewal booking was not cancelled.', '', 'info');
                }
            });
        });
    </script>
