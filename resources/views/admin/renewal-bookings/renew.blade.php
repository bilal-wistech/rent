    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Booking # {{ $booking->id }} Renewal Form</h1>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-info">
                            ...
                            <div class="container my-5">
                                <form method="post" action="{{ route('renewal-bookings.store-renewal-booking') }}"
                                    class="form-horizontal" id="booking_form" accept-charset="UTF-8">
                                    {{ csrf_field() }}
                                            ...
                                            {{-- <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control select2" name="booking_property_status"
                                                        ...
                                                        <option selected value="booked not paid">
    ...
    <script>
        $(document).ready(function() {
            ...
            function handleDateClick(propertyId) {
                ...
                $.ajax({
                    url: '{{ route('renewal-bookings.renewal.check-booking-exists') }}',
                    type: 'POST',
                    data: {
                    ...
                    success: function(response) {
                        if (response.exists) {
                            ...
                            $('#start_date').val(response.suggested_renewal_dates.start_date);
                            $('#end_date').val(response.suggested_renewal_dates.end_date);
            ...
            function updateCalculations(pricingType, pricingTypeAmount, startDate, endDate, propertyId) {
                ...
                `;
                        ...
                        // `);
                            ...
                            let adminId = "{{ Auth::guard('admin')->id() }}";
        ...
        <input type="hidden" name="min_stay" value="1">
        <input type="hidden" name="booking_added_by" id="booking_added_by" value="${adminId}">
        <input type="hidden" name="booking_type" id="booking_type" value="${bookingType}">
        <input type="hidden" name="status" id="booking_status" value="${bookingStatus}">
        <input type="hidden" name="booking_property_status" id="booking_property_status" value="booked not paid">
