    ...
    <div class="panel-body">
        ...
        <ul class="nav navbar-pills nav-tabs nav-stacked no-margin d-flex flex-column f-14" role="tablist">
            ...
            @if (Permission::has_permission(Auth::guard('admin')->user()->id, 'google_recaptcha'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/google-recaptcha-api-information' ? 'active' : '' }}">
                    <a href="{{ url('admin/settings/google-recaptcha-api-information') }}" data-group="profile">Google
                        reCaptcha</a>
                </li>
            @endif
            ...
            @if (Permission::has_permission(Auth::guard('admin')->user()->id, 'manage_banners'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/banners' || Route::current()->uri() == 'admin/settings/add-banners' || Route::current()->uri() == 'admin/settings/edit-banners/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'starting_cities_settings'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/starting-cities' || Route::current()->uri() == 'admin/settings/add-starting-cities' || Route::current()->uri() == 'admin/settings/edit-starting-cities/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_property_type'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/property-type' || Route::current()->uri() == 'admin/settings/add-property-type' || Route::current()->uri() == 'admin/settings/edit-property-type/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'space_type_setting'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/space-type' || Route::current()->uri() == 'admin/settings/add-space-type' || Route::current()->uri() == 'admin/settings/edit-space-type/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_bed_type'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/bed-type' || Route::current()->uri() == 'admin/settings/add-bed-type' || Route::current()->uri() == 'admin/settings/edit-bed-type/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_currency'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/currency' || Route::current()->uri() == 'admin/settings/add-currency' || Route::current()->uri() == 'admin/settings/edit-currency/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_country'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/country' || Route::current()->uri() == 'admin/settings/add-country' || Route::current()->uri() == 'admin/settings/edit-country/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_amenities_type'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/amenities-type' || Route::current()->uri() == 'admin/settings/add-amenities-type' || Route::current()->uri() == 'admin/settings/edit-amenities-type/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_language'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/language' || Route::current()->uri() == 'admin/settings/add-language' || Route::current()->uri() == 'admin/settings/edit-language/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_metas'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/metas' || Route::current()->uri() == 'admin/settings/edit_meta/{id}' ? 'active' : '' }}">
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'api_informations'))
                <li class="{{ Route::current()->uri() == 'admin/settings/api-informations' ? 'active' : '' }}">
                    <a href="{{ url('admin/settings/api-informations') }}" data-group="api_informations">Api
                        Credentials</a>
                </li>
            @endif
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_roles'))
                <li
                    class="{{ Route::current()->uri() == 'admin/settings/roles' || Route::current()->uri() == 'admin/permissions' || Route::current()->uri() == 'admin/settings/add-role' || Route::current()->uri() == 'admin/settings/edit-role/{id}' ? 'active' : '' }}">
