...
<html lang="en">
	<head>
		...
		<meta property="og:image"              content="{{ (isset($property_id) && !empty($property_id && isset($property_photos[0]->photo) )) ? url('images/property/' . $property_id . '/' . $property_photos[0]->photo) : getBanner() }}" />
